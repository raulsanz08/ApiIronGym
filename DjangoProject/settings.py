...
INSTALLED_APPS = [
    ...
    "django.contrib.auth",
    "django.contrib.contenttypes",  # ✅ Agregar esta línea
    "django.contrib.sessions",
    "django.contrib.messages",
    "django.contrib.staticfiles",
    "rest_framework",
    "rest_framework.authtoken",  # Para autenticación con tokens
    "corsheaders",# Para permitir conexiones desde Android
    "core",
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'IronGym',  # Nombre de la base de datos
        'USER': 'root',  # Usuario de MySQL (según Workbench)
        'PASSWORD': 'root',  # La contraseña que usas en Workbench
        'HOST': '127.0.0.1',  # MySQL Workbench usa localhost o 127.0.0.1
...
# Permitir todas las conexiones desde cualquier origen (para desarrollo)
